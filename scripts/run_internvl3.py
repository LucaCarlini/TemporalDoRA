...
def parse_args():
    ...
    parser.add_argument(
        ...
        choices=[
            ...
            "stlora_mhatt_enc",
            "stdora_mhatt_enc",
            "stlora_standard_mhatt_enc",
            "stdora_standard_mhatt_enc",
            "stlora_selfatt_enc",
            "stdora_selfatt_enc",
            "stlora_standard_selfatt_enc",
            "stdora_standard_selfatt_enc",
            "stlora_lstm_enc",
            "stdora_lstm_enc",
            "stlora_standard_lstm_enc",
            "stdora_standard_lstm_enc",
            "stmamba_enc",
            "stdora_mamba_enc",
            "stmamba_standard_enc",
            "stdora_standard_mamba_enc",
            "timeshiftlora_enc",
            "timeshiftdora_enc",
            "st_adapter_enc",
            "gated_headwise",
    ...
    parser.add_argument(
        ...
        choices=[
            ...
            "stlora_mhatt",
            "stdora_mhatt",
            "stlora_standard_mhatt",
            "stdora_standard_mhatt",
            "stlora_selfatt",
            "stdora_selfatt",
            "stlora_standard_selfatt",
            "stdora_standard_selfatt",
            "stlora_lstm",
            "stdora_lstm",
            "stlora_standard_lstm",
            "stdora_standard_lstm",
            "stmamba",
            "stdora_mamba",
            "stmamba_standard",
            "stdora_standard_mamba",
            "timeshiftlora",
            "timeshiftdora",
        ],
        default="lora",
    ...
    parser.add_argument(
        ...
        type=int,
        default=384,
        help="Bottleneck channels for ST-Adapter.",
    )
    parser.add_argument(
        "--st_adapter_kernel_t",
        type=int,
        default=3,
        help="Temporal kernel size for ST-Adapter depthwise 3D convolution.",
    )
    parser.add_argument(
        "--st_adapter_kernel_h",
        type=int,
        default=1,
        help="Spatial height kernel size for ST-Adapter depthwise 3D convolution.",
    )
    parser.add_argument(
        "--st_adapter_kernel_w",
        type=int,
        default=1,
        help="Spatial width kernel size for ST-Adapter depthwise 3D convolution.",
    )
    parser.add_argument(
        "--st_adapter_disable_cudnn",
        action="store_true",
        help="Disable cuDNN in ST-Adapter depthwise 3D convolution.",
    )
    parser.add_argument(
        "--st_bottleneck",
        type=int,
